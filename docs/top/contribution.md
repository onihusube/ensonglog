...
[Github](https://github.com/onihusube/ensonglog)のIssue/Pull Requestからお願いします。ただし、この方法はGithubアカウントが必要になる他、Githubの使い方にある程度慣れが必要です。

情報の追記・修正については直接編集してPRを出して頂けると助かります。その他の問い合わせはIssueを立ててください。
